#-----------------------------------------------------------------
# NVRServer adapted by Juancho ('arm-hisiv500-linux' platform) '19
#-----------------------------------------------------------------

QT += core
QT -= gui

CONFIG(release): TARGET  = nvrServer
CONFIG                  += console
CONFIG                  -= app_bundle

TEMPLATE        = app
QMAKE_CXXFLAGS += -std=c++0x -fpermissive
DEFINES        += __STDC_LIMIT_MACROS __STDC_CONSTANT_MACROS __STDC_LIMIT_MACROS LOCALE_NOT_USED
LIBS           += -Lffmpeg/lib -lavformat -lavdevice -lavfilter -lavcodec -lavutil -lswresample -lswscale
